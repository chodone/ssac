...
> 배열 데이터를 변수에 대입 => 배열변수 에는 배열데이터가 저장되어 있는 메모리 위치값(주소) 저장
>
...
> - 전역 공간에서 사용: 전역 전체를 가리킴
> - 함수 공간에서 사용 : 전역 전체를 가리킴
...
> querySelectorAll()
>
> - 한 종류의 메서드롤 id,class,tag 요소로 접근하는데 모두 사용 가능
> - css selector 사용방법과 동일한

### Create, Append Element(Node)

> document.createElement()
>
> document.appendChile()

### Vanilla JS / jquery

> Vanilla JS : 라이브러리나 프레임워크 사용 없이 순수 자바스크립트로 개발하는 것
>
